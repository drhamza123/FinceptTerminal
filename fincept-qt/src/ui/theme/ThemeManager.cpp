...
const ThemeTokens THEME_GUARDIAN = {
    .name = "Guardian",
    .bg_base = "#080808",
    .bg_surface = "#0a0a0a",
    .bg_raised = "#111111",
    ...
    .font_family = "'Consolas','Courier New',monospace",
    .font_size_base = 14,
    .chart_colors = {"#22c55e", "#0891b2", "#16a34a", "#dc2626", "#2563eb", "#ca8a04"},
};

ThemeManager::ThemeManager() : QObject(nullptr), current_(THEME_GUARDIAN) {}
