...
QWidget* DocsScreen::page_welcome() {
    ...
    vl->addWidget(make_heading("AI STOCK GUARDIAN  —  DOCUMENTATION"));
    ...
    vl->addWidget(
        make_section_panel("■", "WHAT IS AI STOCK GUARDIAN?",
                           "AI Stock Guardian is a professional-grade desktop financial intelligence platform "
                           ...
                           "With 45+ integrated screens, real-time WebSocket feeds, embedded Python analytics, "
                            "and support for 15+ broker integrations, AI Stock Guardian bridges the gap between "
...
QWidget* DocsScreen::page_getting_started() {
    ...
    vl->addWidget(make_muted_label("Your first steps with AI Stock Guardian"));
    ...
    vl->addWidget(make_section_panel("1", "LAUNCH & LOGIN",
                                     "When you first launch AI Stock Guardian, you'll see the login screen. "
                                     "You can either:\n\n"
    ...
    vl->addWidget(make_section_panel("4", "SUBSCRIPTION PLANS",
                                     "AI Stock Guardian offers tiered access:\n\n"
    ...
    return make_page("KEYBOARD SHORTCUTS", "Global shortcuts and navigation keys",
                     {
                         {"GLOBAL SHORTCUTS", "F11  — Toggle fullscreen mode\n"
                                              ...
                                              "Ctrl+P — Capture screenshot (saved to ~/GuardianScreenshot_*.png)"},
