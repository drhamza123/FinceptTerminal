...
ContactScreen::ContactScreen(QWidget* parent) : QWidget(parent) {
    ...
    // ── Contact Information ──────────────────────────────────────────────────
    {
        ...
        grid->addWidget(make_contact_card("EMAIL SUPPORT", "support@guardian.local", "Response within 4-6 hours"), 0, 0);
        grid->addWidget(make_contact_card("PHONE SUPPORT", "Contact: support@guardian.corp", "Mon-Fri, 9AM-6PM EST"), 0, 1);
        grid->addWidget(make_contact_card("SUPPORT HOURS", "Mon-Fri 9AM-6PM EST", "Saturday 10AM-4PM EST"), 1, 0);
        grid->addWidget(make_contact_card("OFFICE", "Guardian Corp", "New York, United States"), 1, 1);
    ...
    // ── Quick Actions ────────────────────────────────────────────────────────
    {
        ...
        connect(email_btn, &QPushButton::clicked, this,
                []() { QDesktopServices::openUrl(QUrl("mailto:support@guardian.local")); });
    ...
    // ── Common Issues ────────────────────────────────────────────────────────
    {
        ...
        const Issue issues[] = {
            {"Cannot log in or forgot password",
             "Use the Forgot Password option on the login screen, or contact support@guardian.local"},
