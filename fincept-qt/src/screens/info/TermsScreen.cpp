...
TermsScreen::TermsScreen(QWidget* parent) : QWidget(parent) {
    ...
    pvl->addWidget(body_text("By accessing or using AI Stock Guardian (\"the Service\"), you agree to be bound by these "
                             "Terms of Service. If you do not agree to these terms, do not use the Service."));

    // Section 2
    pvl->addWidget(section_heading("2", "DESCRIPTION OF SERVICE"));
    pvl->addWidget(body_text("AI Stock Guardian is a desktop financial intelligence terminal providing market data, "
    ...
    pvl->addWidget(
        body_text("The Service is provided \"as is\" without warranty of any kind. Guardian Corp shall not "
    ...
    pvl->addWidget(body_text("For questions about these Terms, contact us at support@guardian.local"));
