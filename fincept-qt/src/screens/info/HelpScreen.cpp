...
QWidget* HelpScreen::build_page() {
    ...
    // ── Hero banner ───────────────────────────────────────────────────────────
    {
        ...
        auto* sub = new QLabel(tr("Find answers, get support, and connect with the Guardian community."));
        sub->setStyleSheet(
        ...
        chips_vl->addWidget(make_chip("✉", "support@guardian.local", colors::CYAN, "mailto:support@guardian.local"));
        chips_vl->addWidget(
        ...
        const FAQ faqs[] = {
            ...
            {"📊", tr("How do I connect a broker?"),
             tr("Navigate to Settings → Brokers, select your broker from the list, and enter your "
                "API key and secret. Guardian supports 18+ brokers including Zerodha, Angel One, "
                "Upstox, Interactive Brokers, and more.")},

            {"🐍", tr("Why does Python install at first launch?"),
             tr("Guardian embeds Python for 1300+ analytics scripts covering equity, "
            ...
            {"🔒", tr("Is my data secure?"),
             tr("Credentials are stored encrypted via SecureStorage (OS keychain on each platform). "
                "API keys are never logged or sent to Guardian servers — they are used only for "
    ...
    // ── Getting Started ────────────────────────────────────────────────────────
    {
        vl->addWidget(section_header(tr("GETTING STARTED"), tr("New to Guardian? Start here")));
        vl->addSpacing(8);
        ...
        const Step steps[] = {
            {"1", tr("Create an account"),       tr("Register via the app or use the in-app sign-up.")},
    ...
    // ── Contact & Resources ───────────────────────────────────────────────────
    {
        ...
        const Contact contacts[] = {
            {"✉",  tr("Email Support"),   "support@guardian.local",                       "mailto:support@guardian.local"},
            {"💬", tr("Discord Server"),  "discord.gg/ae87a8ygbN",                    "https://discord.gg/ae87a8ygbN"},
            {"🌐", tr("Website"),         "fincept.in",                               "http://localhost:8150"},
