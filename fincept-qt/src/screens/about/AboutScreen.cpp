...
AboutScreen::AboutScreen(QWidget* parent) : QWidget(parent) {
    ...
    // ── Version Information ───────────────────────────────────────────────────
    {
        ...
        left->setSpacing(4);
        auto* name = new QLabel("AI Stock Guardian");
        ...
        // Footer bar
        auto* foot = new QLabel("© 2024-2026 Guardian Corp. All rights reserved.");
    ...
    // ── License — two columns ─────────────────────────────────────────────────
    {
        ...
        // Commercial
        {
            ...
            // Footer link
            auto* foot = new QLabel("support@guardian.local");
            foot->setStyleSheet(QString("color: %1; font-size: 11px; background: transparent; "
                                        "padding: 6px 14px; border-top: 1px solid %2; "
                                        "font-family: 'Consolas','Courier New',monospace;")
                                    .arg(ui::colors::CYAN(), ui::colors::BORDER_DIM()));
    ...
    // ── Trademarks ────────────────────────────────────────────────────────────
    {
        ...
        auto* desc = new QLabel("\"Guardian\", \"AI Stock Guardian\", and associated logos are trademarks of "
                                "Guardian Corp. Use of these marks requires explicit written permission.");
        desc->setStyleSheet(BODY());
        desc->setWordWrap(true);
        bvl->addWidget(desc);

        auto* perm =
            new QLabel("Permission is not granted to use Guardian trademarks in a way that suggests "
                       "affiliation with or endorsement by Guardian Corp without prior written consent.");
    ...
    // ── Resources — 3×2 grid ─────────────────────────────────────────────────
    {
        ...
        const Link links[] = {
            ...
            {"Official Website", "http://localhost:8150"},
        };
    ...
    // ── Contact ───────────────────────────────────────────────────────────────
    {
        ...
        const Contact contacts[] = {
            {"GENERAL", "support@guardian.local"},
            {"COMMERCIAL", "support@guardian.local"},
            {"SECURITY", "support@guardian.local"},
            {"LEGAL", "support@guardian.local"},
        };
