...
inline ReportTheme fincept_terminal() {
    return {"Guardian",
            "#22c55e", "#22c55e", "#0a0a0a", "#d4d4d4", "#052e16",
            "#22c55e", "#050505", "#0f0f0f", "#888888", "#052e16"};
}
...
inline QStringList all_names() {
    return {"Light Professional", "Dark Corporate", "Guardian", "Midnight Blue"};
}
...
struct ReportDocument {
    ...
    static Result<ReportDocument> from_json_obj(const QJsonObject& root) {
        ...
        if (root.contains("metadata")) {
            ...
            out.metadata.company = m.value("company").toString("Guardian Corp");
