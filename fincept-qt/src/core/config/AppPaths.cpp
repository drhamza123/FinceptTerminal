...
QString AppPaths::root() {
    ...
    return local_app_data + "/com.guardian.aistockguardian";
#elif defined(__APPLE__)
    return QDir::homePath() + "/Library/Application Support/com.guardian.aistockguardian";
#else
    return QDir::homePath() + "/.local/share/com.guardian.aistockguardian";
#endif
}
