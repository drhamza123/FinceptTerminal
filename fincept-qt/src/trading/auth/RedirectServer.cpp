...
constexpr const char* kResponseHtml =
    ...
    "<title>AI Stock Guardian - Broker login</title>"
    "<style>body{font-family:system-ui;background:#080808;color:#e5e5e5;"
    "display:flex;align-items:center;justify-content:center;height:100vh;margin:0}"
    "div{text-align:center}h1{color:#22c55e;font-size:20px}p{color:#808080}</style>"
    "</head><body><div><h1>Login captured</h1>"
    "<p>You can close this tab and return to AI Stock Guardian.</p></div></body></html>";
}
